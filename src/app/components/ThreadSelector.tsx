...
export function ThreadSelector({
    ...
    return (
        <div className="flex items-center w-full justify-between pt-2 gap-2">
            <div className="flex items-center w-full justify-start gap-1">{currentThread?.title}</div>
            <div className="flex items-center w-full justify-end gap-1">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button
                            variant="ghost" className="cursor-pointer w-auto "
                        >
                            <History className="sm:!size-5 !size-4.5" />
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent
                        align="start"
                ...
                <Button variant="ghost" className="cursor-pointer" onClick={() => onNewThread()}>
                    <SquarePen className="!size-4.5 sm:!size-5" />
                </Button>
            </div>
        </div>
    );
